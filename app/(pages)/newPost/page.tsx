...
export default async function NewPost() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    data.secondaryImgUrl = secondaryImg
      ? await uploadImg(secondaryImg, "img")
      : "";
  ...
  return (
    <main className="mb-20">
      ...
      <form
        className="flex flex-col gap-4 border border-gray-300 p-8 rounded-lg shadow-lg"
        onSubmit={onSubmit}
      >
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="show as main title"
        ...
        <div>
          ...
          <textarea
            rows={5}
            className="textarea textarea-bordered w-full max-w-lg dark:bg-transparent dark:text-gray-300 dark:border-gray-300"
            placeholder="show as post description"
            {...register("info")}
            required
          ></textarea>
        </div>
        ...
        <div>
          ...
          <textarea
            rows={5}
            className="textarea textarea-bordered w-full max-w-lg dark:bg-transparent dark:text-gray-300 dark:border-gray-300"
            placeholder="show as post main text"
            {...register("mainText")}
          ></textarea>
        </div>
        ...
        <div>
          ...
          <input
            ...
            id="icon"
            name="icon"
            className="file-input file-input-sm file-input-bordered w-full max-w-xs dark:bg-transparent dark:text-gray-300 dark:border-gray-300"
        ...
        <div>
          ...
          <input
            ...
            id="primary"
            name="primary"
            className="file-input file-input-sm file-input-accent file-input-bordered w-full max-w-xs dark:bg-transparent dark:text-gray-300 dark:border-gray-300"
            onChange={(e: any) => setPrimaryImg(e.target.files[0])}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            id="secondary"
            name="secondary"
            className="file-input file-input-sm file-input-info file-input-bordered w-full max-w-xs dark:bg-transparent dark:text-gray-300 dark:border-gray-300"
            onChange={(e: any) => setSecondaryImg(e.target.files[0])}
          />
        </div>
        ...
        <div className="flex gap-2 pt-4 justify-end">
          <button
            className="btn btn-sm btn-outline dark:text-gray-300"
            type="submit"
          >
            Submit
          </button>
      ...
      <form
        className="flex flex-col gap-4 border border-gray-300 p-8 rounded-lg shadow-lg mt-8"
        onSubmit={submitCategory}
      >
        <p className="text-lg mb-4 font-bold tracking-wide">
          Create new category
        </p>
        <div>
          ...
          <div className="flex justify-between items-center">
            <input
              type="text"
              className="input input-info input-bordered w-full max-w-xs dark:bg-transparent dark:text-gray-300 dark:border-gray-300"
              ref={newCategory}
              required
            />
            <button
