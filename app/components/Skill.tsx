        ...
        <>
            <div className="flex flex-col w-full border-opacity-50 mb-20">
                <div>
                    ...
                    <p className="text-gray-600 mb-4 dark:text-gray-400">I&apos;m an enthusiastic full-stack developer, always excited to learn and apply my skills in professional settings. Connect with me if you interested &#128515;</p>
                ...
                <div className="flex flex-col items-center gap-4 lg:flex-row">
                    <div className="w-3/4 h-full lg:w-full shadow-md rounded-lg hover:shadow-2xl hover:scale-105 duration-200 ease-in dark:shadow-2xl">
                        ...
                        <div className="text-center p-4 text-sm text-gray-500 font-normal">
                            <ul>
                                ...
                                <li>
                                    <a href="https://redux.js.org/" target="_blank" className="hover:underline line-clamp-1">MobX / Redux</a>
                                </li>    
                                <li>
                    ...
                    <div className="w-3/4 h-full lg:w-full shadow-md rounded-lg hover:shadow-2xl hover:scale-105 duration-200 ease-in dark:shadow-2xl">
                        ...
                        <div className="text-center p-4 text-sm text-gray-500 font-normal">
                            <ul>
                                ...
                                <li>
                                    <a href="https://nestjs.com/" target="_blank" className="hover:underline line-clamp-1">Nest.js</a>
                                </li>
                                <li>
                    ...
                    <div className="w-3/4 h-full lg:w-full shadow-md rounded-lg hover:shadow-2xl hover:scale-105 duration-200 ease-in dark:shadow-2xl">
                        ...
                        <div className="text-center p-4 text-sm text-gray-500 font-normal">
                            <ul>
                                <li>
                                    <a href="https://jestjs.io/" target="_blank" className="hover:underline line-clamp-1">Jest / RTL</a>
                                </li>
                                <li>
                                    <a href="https://www.docker.com/" target="_blank" className="hover:underline line-clamp-1">Docker</a>
                                </li>
                                <li>
                                    <a href="https://www.atlassian.com/software/jira" target="_blank" className="hover:underline line-clamp-1">Scrum Dev / Jira</a>
                                </li>
                                <li>
