    ...
    return (
        <main className="mb-20">
            ...
            <section className="mb-16">
                ...
                <p className="text-sm text-gray-400 font-light dark:text-gray-600">Feb 13, 2023</p>
                <br/>
            ...
            <section className="flex gap-4 flex-col items-center mb-16">
                <Image src="https://res.cloudinary.com/siran-chao/image/upload/v1687722247/asset/projects/museum1_odolpc.jpg" alt="museum-demo" width={500} height={400} className="rounded-lg shadow-xl"/>
                <Image src="https://res.cloudinary.com/siran-chao/image/upload/v1687722247/asset/projects/museum2_eut1wq.jpg" alt="museum-demo" width={500} height={400} className="rounded-lg shadow-xl"/>
            </section>

            {/* Tech stack section */}
            <section className="mb-16">
                <p className="text-xl mb-4 font-semibold underline">Tech stack</p>
                <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">This application is built on MERN stack and primarily use Next.js as production framework. Utilize Next.js to handle SSR/SSG, page routing, and SEO optimization. In the API layer, we use public API from Metropolitan Museum of Art to fetch artworks data. Also there is a separate server application using Node and express.js to handling user authentication and application data in MongoDB. <span className="text-blue-500 font-regular hover:underline">(<a href="https://github.com/siranchao/my_museum_api" target="_blank">see API repo</a>)</span></p>
                <br />
                ...
                <ul className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    <li><span className="font-semibold pr-2">Front-end:</span> React, Next.13, react-bootstrap, Jotai, JWT</li>
                    <li><span className="font-semibold pr-2">Back-end:</span> JavaScript, Express.js, Node, MongoDB, Mongoose, Passport, JWT</li>
            ...
            <section className="mb-16">
                ...
                <ul className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    ...
                    <li><span className="font-semibold pr-2">-</span> All features are available for registed users only</li>
                    <li><span className="font-semibold pr-2">-</span> View artworks by department or category</li>
                    <li><span className="font-semibold pr-2">-</span> Simple search or advanced search</li>
                    <li><span className="font-semibold pr-2">-</span> Save favorite artworks</li>
                    <li><span className="font-semibold pr-2">-</span> View artwork profile and specific infomation</li>
                    <li><span className="font-semibold pr-2">-</span> User&apos;s search history are stored for future reference</li>
                </ul>
            </section>
