    ...
    return (
        <main className="mb-20">
            ...
            <section className="mb-16">
                ...
                <br/>
                <p className="text-sm font-semibold leading-relaxed text-gray-600 dark:text-gray-400">App URL: <a className="text-blue-500 font-regular hover:underline" href="https://siran-kitchen.cyclic.app/" target="_blank">https://siran-kitchen.cyclic.app/</a></p>
                <p className="text-sm font-semibold leading-relaxed text-gray-600 dark:text-gray-400">GitHub Repo: <a className="text-blue-500 font-regular hover:underline" href="https://github.com/siranchao/siran_kitchen" target="_blank">https://github.com/siranchao/siran_kitchen</a></p>
                <br/>
