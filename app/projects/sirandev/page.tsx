    ...
    return (
        <main className="mb-20">
            ...
            <section className="mb-16">
                ...
                <br/>
                <p className="text-sm font-semibold leading-relaxed text-gray-600 dark:text-gray-400">URL: <a className="text-blue-500 font-regular hover:underline" href="https://www.siran.dev/" target="_blank">https://www.siran.dev/</a></p>
                <p className="text-sm font-semibold leading-relaxed text-gray-600 dark:text-gray-400">GitHub: <a className="text-blue-500 font-regular hover:underline" href="https://github.com/siranchao/siran.dev" target="_blank">https://github.com/siranchao/siran.dev</a></p>
                <br/>
            ...
            <section className="mb-16">
                ...
                <p className="text-sm font-regular leading-relaxed text-gray-600 dark:text-gray-400">Email: demo@gg.com</p>
