    ...
    return (
        <main className="mb-20">
            ...
            <section className="mb-16">
                <p className="text-2xl mb-4 font-bold tracking-wide">Shopee E-Commerce</p>
                <p className="text-sm text-gray-400 font-light dark:text-gray-600">Oct 8, 2023</p>
                <br/>
            ...
            <section className="flex gap-4 flex-col items-center mb-16">
                <Image src="https://res.cloudinary.com/siran-chao/image/upload/v1696903478/asset/projects/shopee-3_tokkx4.jpg" alt="demo" width={500} height={400} className="rounded-lg shadow-xl"/>
                <Image src="https://res.cloudinary.com/siran-chao/image/upload/v1696903476/asset/projects/shopee-4_a4qgzu.jpg" alt="demo" width={500} height={400} className="rounded-lg shadow-xl"/>
                <Image src="https://res.cloudinary.com/siran-chao/image/upload/v1696903476/asset/projects/shopee-5_avewsx.jpg" alt="demo" width={500} height={400} className="rounded-lg shadow-xl"/>
                <Image src="https://res.cloudinary.com/siran-chao/image/upload/v1696903477/asset/projects/shopee-2_jnnczo.jpg" alt="demo" width={500} height={400} className="rounded-lg shadow-xl"/>
                <Image src="https://res.cloudinary.com/siran-chao/image/upload/v1696903476/asset/projects/shopee-1_t0wfxx.jpg" alt="demo" width={500} height={400} className="rounded-lg shadow-xl"/>
            </section>
            ...
            <section className="mb-16">
                ...
                <ul className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    <li><span className="font-semibold pr-2">Frontend JS framework:</span> React, Next13</li>
                    <li><span className="font-semibold pr-2">CSS & UI framework:</span>Tailwind.css, Headless UI, shadcn/ui, Lucide React</li>
                    <li><span className="font-semibold pr-2">State management:</span>Zustand</li>
                    <li><span className="font-semibold pr-2">Form & validation:</span>React-hook-form, Zod</li>
                    <li><span className="font-semibold pr-2">Data visualization:</span>Recharts</li>
                    <li><span className="font-semibold pr-2">Authentication & User management:</span>Clerk</li>
                    <li><span className="font-semibold pr-2">Image store & management:</span>Cloudinary</li>
                    <li><span className="font-semibold pr-2">Backend web APIs:</span>Next API router, Prisma ORM</li>
                    <li><span className="font-semibold pr-2">Database:</span>MySQL, PlanetScale(serverless database)</li>
            ...
            <section className="mb-16">
                ...
                <ul className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    <li><span className="font-semibold pr-2">-</span> Admin: view dashboard tables and charts from real time data, KPI and trend analysis</li>
                    <li><span className="font-semibold pr-2">-</span> Admin: create, update and delete essential contents e.g APIs, product info</li>
                    <li><span className="font-semibold pr-2">-</span> Admin: view and manage all orders generated from store</li>
                    <li><span className="font-semibold pr-2">-</span> Admin: create and manage multiple stores</li>
                    <li><span className="font-semibold pr-2">-</span> Store: locally stored shopping cart, not session required</li>
                    <li><span className="font-semibold pr-2">-</span> Store: support multiple payment methods, Credit/Debit Card</li>
                    <li><span className="font-semibold pr-2">-</span> Fully responsive design, but larger screen are recommended for Admin app</li>
                </ul>
            </section>
